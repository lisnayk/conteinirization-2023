...
3. Створити docker-compose.yml файл для запуску сервісів наведених у таблиці 1 та зображены на рис 1.
...
4. Оновити інформацію про себе у сервісі **frontend**. 
5. Запустити сервіси за допомогою команди `docker-compose up -d`.
6. Перевірити роботу сервісів в браузері. У разі успішної конфігурації результат буде аналогічним рис. 2.
